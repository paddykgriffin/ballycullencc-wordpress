...
switch ( $template ) {
	...
	case 'exodoswp':
		...
		break;
	default:
		echo apply_filters( 'sm_templates_wrapper_start', '<div class="wpfc-sermon-container ' . $additional_classes . '"><div class="container"><div class="row justify-content-center">' );
		break;
}
